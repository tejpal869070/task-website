  ...
  return (
    <div>
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        <img alt="omg" src={likeEarn} className="w-full" />
                    ...
                    >
                      ...
                      <td className="px-6 py-4 ">
                        {item.status === "Completed" ? (
                          ...
                          <MdError className="w-5 h-5 cursor-pointer" onClick={() => handleLikePost(item)}/>
                        ) : item.status === "Pending" ? (
                          <FaExternalLinkAlt
                          ...
                          <MdAccessTimeFilled className="w-5 h-5 cursor-pointer" onClick={() => handleLikePost(item)}/>
                        )}
                      </td>
                    </tr>
                  ))}
              ...
              {isLikePopupOpen && (
                <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 z-[999]">
                  <div className="bg-white p-8 rounded shadow-lg relative">
                    ...
                    <LikeVideoPopup singleTask={singleTask} />
                  </div>
                </div>
              )}
            </tbody>
