...
const Contact = () => {
  ...
  return (
    <div>
      ...
      >
        <section className="relative z-10 overflow-hidden bg-transparent py-10 dark:bg-dark lg:py-16">
          <div className="container">
            <div className="-mx-4 flex flex-wrap lg:justify-between">
              ...
              <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                <div className="relative rounded-lg bg-[#4769b340] p-8 shadow-lg dark:bg-dark-2 sm:p-12">
                  <form onSubmit={handleSubmit} class="space-y-8">
                    ...
                    <button
                      type="submit"
                      class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-[#7f7fff] sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                    >
                      Send message
                    </button>
                  </form>
